...
const SommelierAssistant: React.FC<SommelierAssistantProps> = ({ wine }) => {
  ...
  return (
    <div className="bg-winery-dark/40 border border-winery-gold/20 p-8 mt-12 backdrop-blur-md">
      <div className="flex items-center gap-4 mb-6">
        <div className="w-10 h-10 rounded-full bg-winery-gold/10 flex items-center justify-center text-winery-gold">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 22s-2-1-2-4-3-4-3-4V5c0-1.1.9-2 2-2V2H5v1c1.1 0 2 .9 2 2v9s0 1-3 4-2 4-2 4h20Z"/><path d="M7 8h10"/></svg>
        </div>
        <div>
          <h4 className="font-serif italic text-lg">Digital Sommelier</h4>
          <p className="text-[10px] uppercase tracking-widest text-winery-gold/60">Expert guidance instantly</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {response && (
          <div className="p-4 bg-winery-cream/5 border-l-2 border-winery-gold animate-fade-in">
            <p className="text-sm font-light leading-relaxed italic text-winery-cream/90">{response}</p>
          </div>
        )}
        ...
        <div className="relative">
          ...
          >
            {loading ? (
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="m5 12 7-7 7 7"/><path d="M12 19V5"/></svg>
            )}
          </button>
        </div>
      </div>
